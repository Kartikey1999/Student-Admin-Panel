...
$stmt = $conn->prepare("select * from tbl1queries where queryId=:queryId");
...
<div class="col-md-10 col-sm-10 dynamic-part">
	...
	<form action="edit-queries-process.php" method="post">
			...
			<div class="col-md-10">
				<div class="card">
					<div class="card-body body1">
						...
						<input type="date" name="enrollDate" class="form-control" value="<?php echo $enrollDate ?>" placeholder="Enter Enroll Date"/>
						<label>Courses</label>
						<input type="text" name="course" class="form-control" value="<?php echo $course ?>" placeholder="write your Course"/>
